var Godot = (() => {
  ...
  return async function (moduleArg = {}) {
    ...
    function _godot_audio_sample_start(
      ...
      const startOptions = { offset, volume, playbackRate: 1, pitchScale, start: true };
    ...
    function _godot_js_display_cursor_set_custom_shape(
      ...
      if (p_len > 0) {
        ...
        GodotDisplayCursor.cursors[shape] = { url, x: p_hotspot_x, y: p_hotspot_y };
      } else {
    ...
    function assignWasmExports(wasmExports) {
      ...
      __Z14godot_web_mainiPPc = Module["__Z14godot_web_mainiPPc"] = wasmExports["rf"];
      _main = Module["_main"] = wasmExports["sf"];
      _malloc = Module["_malloc"] = wasmExports["tf"];
      _fflush = wasmExports["uf"];
      __emwebxr_on_input_event = Module["__emwebxr_on_input_event"] = wasmExports["vf"];
      __emwebxr_on_simple_event = Module["__emwebxr_on_simple_event"] = wasmExports["wf"];
    ...
    var wasmImports = {
      Pc: ___call_sighandler,
      gd: ___syscall_chdir,
      Ya: ___syscall_chmod,
      hd: ___syscall_faccessat,
      ed: ___syscall_fchmod,
      U: ___syscall_fcntl64,
      dd: ___syscall_fstat64,
      $c: ___syscall_ftruncate64,
      _c: ___syscall_getcwd,
      Oc: ___syscall_getdents64,
      Aa: ___syscall_ioctl,
      bd: ___syscall_lstat64,
      Vc: ___syscall_mkdirat,
      Uc: ___syscall_mknodat,
      ad: ___syscall_newfstatat,
      Wa: ___syscall_openat,
      Nc: ___syscall_readlinkat,
      Lc: ___syscall_renameat,
      Sa: ___syscall_rmdir,
      cd: ___syscall_stat64,
      Kc: ___syscall_statfs64,
      Jc: ___syscall_symlinkat,
      Ta: ___syscall_unlinkat,
      id: __abort_js,
      Rc: __emscripten_runtime_keepalive_clear,
      Sc: __gmtime_js,
      Tc: __localtime_js,
      Gc: __setitimer_js,
      jd: __tzset_js,
      fd: _clock_time_get,
      wb: _emscripten_cancel_main_loop,
      Xa: _emscripten_date_now,
      We: _emscripten_force_exit,
      Ic: _emscripten_get_heap_max,
      ka: _emscripten_get_now,
      Hc: _emscripten_resize_heap,
      Mc: _emscripten_set_canvas_element_size,
      Ka: _emscripten_set_main_loop,
      Oa: _emscripten_webgl_commit_frame,
      cc: _emscripten_webgl_create_context,
      Mb: _emscripten_webgl_destroy_context,
      ac: _emscripten_webgl_enable_extension,
      wd: _emscripten_webgl_get_supported_extensions,
      bc: _emscripten_webgl_make_context_current,
      Yc: _environ_get,
      ...
      S: _glColorMask,
      eb: _glCompileShader,
      pd: _glCompressedTexImage2D,
      rd: _glCompressedTexImage3D,
      qd: _glCompressedTexSubImage3D,
      sd: _glCopyBufferSubData,
      Cd: _glCreateProgram,
      gb: _glCreateShader,
      na: _glCullFace,
      m: _glDeleteBuffers,
      ...
      ha: _glDeleteProgram,
      md: _glDeleteQueries,
      pa: _glDeleteRenderbuffers,
      W: _glDeleteShader,
      ob: _glDeleteSync,
      j: _glDeleteTextures,
      N: _glDeleteVertexArrays,
      F: _glDepthFunc,
      x: _glDepthMask,
      e: _glDisable,
      ...
      da: _glDrawBuffers,
      K: _glDrawElements,
      L: _glDrawElementsInstanced,
      r: _glEnable,
      o: _glEnableVertexAttribArray,
      fa: _glEndTransformFeedback,
      nb: _glFenceSync,
      Kd: _glFinish,
      Ha: _glFramebufferRenderbuffer,
      ...
      nd: _glGenQueries,
      Ia: _glGenRenderbuffers,
      v: _glGenTextures,
      M: _glGenVertexArrays,
      ld: _glGenerateMipmap,
      ud: _glGetFloatv,
      vd: _glGetInteger64v,
      aa: _glGetIntegerv,
      xd: _glGetProgramInfoLog,
      bb: _glGetProgramiv,
      db: _glGetShaderInfoLog,
      sa: _glGetShaderiv,
      Z: _glGetString,
      Ud: _glGetSynciv,
      Fd: _glGetUniformBlockIndex,
      Ea: _glGetUniformLocation,
      zd: _glLinkProgram,
      Ba: _glPixelStorei,
      Id: _glReadBuffer,
      Ca: _glReadPixels,
      Nd: _glRenderbufferStorage,
      ...
      Fa: _glTexStorage2D,
      _a: _glTexSubImage3D,
      Ad: _glTransformFeedbackVaryings,
      i: _glUniform1f,
      D: _glUniform1i,
      Dd: _glUniform1iv,
      p: _glUniform1ui,
      ...
      ea: _glVertexAttribIPointer,
      s: _glVertexAttribPointer,
      z: _glViewport,
      Je: _godot_audio_get_sample_playback_position,
      yd: _godot_audio_has_script_processor,
      Jd: _godot_audio_has_worklet,
      mf: _godot_audio_init,
      zc: _godot_audio_input_start,
      sc: _godot_audio_input_stop,
      nf: _godot_audio_is_available,
      qa: _godot_audio_resume,
      Td: _godot_audio_sample_bus_add,
      Sd: _godot_audio_sample_bus_move,
      _d: _godot_audio_sample_bus_remove,
      he: _godot_audio_sample_bus_set_count,
      Ld: _godot_audio_sample_bus_set_mute,
      Pd: _godot_audio_sample_bus_set_send,
      Md: _godot_audio_sample_bus_set_solo,
      Od: _godot_audio_sample_bus_set_volume_db,
      Ue: _godot_audio_sample_is_active,
      Zb: _godot_audio_sample_register_stream,
      Qd: _godot_audio_sample_set_finished_callback,
      af: _godot_audio_sample_set_pause,
      qe: _godot_audio_sample_set_volumes_linear,
      Gb: _godot_audio_sample_start,
      lf: _godot_audio_sample_stop,
      ic: _godot_audio_sample_stream_is_registered,
      Ob: _godot_audio_sample_unregister_stream,
      Ae: _godot_audio_sample_update_pitch_scale,
      td: _godot_audio_script_create,
      od: _godot_audio_script_start,
      Gd: _godot_audio_worklet_create,
      Bd: _godot_audio_worklet_start_no_threads,
      hc: _godot_js_config_canvas_id_get,
      Le: _godot_js_config_locale_get,
      Te: _godot_js_display_alert,
      tc: _godot_js_display_canvas_focus,
      uc: _godot_js_display_canvas_is_focused,
      jc: _godot_js_display_clipboard_get,
      kc: _godot_js_display_clipboard_set,
      wc: _godot_js_display_cursor_is_hidden,
      vc: _godot_js_display_cursor_is_locked,
      xa: _godot_js_display_cursor_lock_set,
      Ra: _godot_js_display_cursor_set_custom_shape,
      xc: _godot_js_display_cursor_set_shape,
      ya: _godot_js_display_cursor_set_visible,
      Fb: _godot_js_display_desired_size_set,
      Rb: _godot_js_display_fullscreen_cb,
      Eb: _godot_js_display_fullscreen_exit,
      Db: _godot_js_display_fullscreen_request,
      dc: _godot_js_display_has_webgl,
      fc: _godot_js_display_is_swap_ok_cancel,
      Pb: _godot_js_display_notification_cb,
      Ib: _godot_js_display_pixel_ratio_get,
      Jb: _godot_js_display_screen_dpi_get,
      Kb: _godot_js_display_screen_size_get,
      gc: _godot_js_display_setup_canvas,
      Wc: _godot_js_display_size_update,
      rc: _godot_js_display_touchscreen_is_available,
      Lb: _godot_js_display_tts_available,
      Na: _godot_js_display_vk_available,
      Nb: _godot_js_display_vk_cb,
      pc: _godot_js_display_vk_hide,
      qc: _godot_js_display_vk_show,
      Qb: _godot_js_display_window_blur_cb,
      Pa: _godot_js_display_window_icon_set,
      Ma: _godot_js_display_window_size_get,
      Hb: _godot_js_display_window_title_set,
      Ve: _godot_js_emscripten_get_version,
      $e: _godot_js_eval,
      Bb: _godot_js_fetch_create,
      La: _godot_js_fetch_free,
      yb: _godot_js_fetch_http_status_get,
      Ab: _godot_js_fetch_is_chunked,
      zb: _godot_js_fetch_read_chunk,
      kf: _godot_js_fetch_read_headers,
      wa: _godot_js_fetch_state_get,
      Ub: _godot_js_input_drop_files_cb,
      Tb: _godot_js_input_gamepad_cb,
      Cb: _godot_js_input_gamepad_sample,
      mc: _godot_js_input_gamepad_sample_count,
      lc: _godot_js_input_gamepad_sample_get,
      Wb: _godot_js_input_key_cb,
      $b: _godot_js_input_mouse_button_cb,
      _b: _godot_js_input_mouse_move_cb,
      Yb: _godot_js_input_mouse_wheel_cb,
      Vb: _godot_js_input_paste_cb,
      Xb: _godot_js_input_touch_cb,
      Ne: _godot_js_input_vibrate_handheld,
      Qa: _godot_js_is_ime_focused,
      Ye: _godot_js_os_download_buffer,
      Re: _godot_js_os_execute,
      vb: _godot_js_os_finish_async,
      Ie: _godot_js_os_fs_is_persistent,
      Se: _godot_js_os_fs_sync,
      Pe: _godot_js_os_has_feature,
      Qe: _godot_js_os_hw_concurrency_get,
      ec: _godot_js_os_request_quit_cb,
      Oe: _godot_js_os_shell_open,
      Ke: _godot_js_pwa_cb,
      Me: _godot_js_pwa_update,
      ub: _godot_js_rtc_datachannel_close,
      ye: _godot_js_rtc_datachannel_connect,
      ve: _godot_js_rtc_datachannel_destroy,
      ze: _godot_js_rtc_datachannel_get_buffered_amount,
      Ee: _godot_js_rtc_datachannel_id_get,
      Be: _godot_js_rtc_datachannel_is_negotiated,
      Fe: _godot_js_rtc_datachannel_is_ordered,
      xe: _godot_js_rtc_datachannel_label_get,
      De: _godot_js_rtc_datachannel_max_packet_lifetime_get,
      Ce: _godot_js_rtc_datachannel_max_retransmits_get,
      we: _godot_js_rtc_datachannel_protocol_get,
      He: _godot_js_rtc_datachannel_ready_state_get,
      Ge: _godot_js_rtc_datachannel_send,
      tb: _godot_js_rtc_pc_close,
      pe: _godot_js_rtc_pc_create,
      oe: _godot_js_rtc_pc_datachannel_create,
      sb: _godot_js_rtc_pc_destroy,
      re: _godot_js_rtc_pc_ice_candidate_add,
      te: _godot_js_rtc_pc_local_description_set,
      ue: _godot_js_rtc_pc_offer_create,
      se: _godot_js_rtc_pc_remote_description_set,
      oc: _godot_js_set_ime_active,
      Sb: _godot_js_set_ime_cb,
      nc: _godot_js_set_ime_position,
      Dc: _godot_js_tts_get_voices,
      Ec: _godot_js_tts_is_paused,
      Fc: _godot_js_tts_is_speaking,
      Bc: _godot_js_tts_pause,
      Ac: _godot_js_tts_resume,
      Cc: _godot_js_tts_speak,
      yc: _godot_js_tts_stop,
      Va: _godot_js_webmidi_close_midi_inputs,
      kd: _godot_js_webmidi_open_midi_inputs,
      le: _godot_js_websocket_buffered_amount,
      ke: _godot_js_websocket_close,
      ne: _godot_js_websocket_create,
      rb: _godot_js_websocket_destroy,
      me: _godot_js_websocket_send,
      ...
      xb: _godot_js_wrapper_object_getvar,
      ...
      ra: _godot_webgl2_glGetBufferSubData,
      ge: _godot_webxr_get_bounds_geometry,
      Yd: _godot_webxr_get_color_texture,
      Xd: _godot_webxr_get_depth_texture,
      fe: _godot_webxr_get_frame_rate,
      Zd: _godot_webxr_get_projection_for_view,
      $d: _godot_webxr_get_render_target_size,
      de: _godot_webxr_get_supported_frame_rates,
      pb: _godot_webxr_get_transform_for_view,
      Wd: _godot_webxr_get_velocity_texture,
      qb: _godot_webxr_get_view_count,
      ie: _godot_webxr_get_visibility_state,
      be: _godot_webxr_initialize,
      je: _godot_webxr_is_session_supported,
      ce: _godot_webxr_is_supported,
      ae: _godot_webxr_uninitialize,
      Vd: _godot_webxr_update_input_source,
      ee: _godot_webxr_update_target_frame_rate,
      Qc: _proc_exit,
    };
